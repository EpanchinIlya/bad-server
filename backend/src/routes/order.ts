...
orderRouter.patch('/:orderNumber', auth, orderValidation.updateOrder, roleGuardMiddleware(Role.Admin), updateOrder)
orderRouter.delete('/:id', auth, orderValidation.deleteOrder, roleGuardMiddleware(Role.Admin), deleteOrder)
